          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-indigo-50 dark:bg-violetAccent-muted text-indigo-700 dark:text-violetAccent border border-indigo-200 dark:border-violetAccent-border">
                  Sequence Memory v2
                </span>
              </div>
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-emerald-500 dark:from-bullish dark:via-cyanAccent dark:to-violetAccent text-white dark:text-slate-950 font-bold text-xs font-mono uppercase tracking-wider shadow-md hover:opacity-95 disabled:opacity-50 transition-all cursor-pointer shrink-0"
            >
              {loading ? (
                <>
                ...
                <>
                  <Play className="h-3.5 w-3.5 fill-current" /> Execute Neural Forecast
                </>
              )}
            </button>
          </div>
